...
export const getPairedCohortSpongeResultURL = ({
    taskUUID,
}) => {
    if (!taskUUID) {
        throw new Error(
            "Missing Paired Cohort Sponge result task UUID."
        );
    }
...
export const getHybridReferenceSpongeResultURL = ({
    taskUUID,
}) => {
    if (!taskUUID) {
        throw new Error(
            "Missing Hybrid Reference Sponge result task UUID."
        );
    }
