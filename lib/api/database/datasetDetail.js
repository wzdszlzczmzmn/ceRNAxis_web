...
export const getDatasetLargeMetaURL = ({
    dataset,
    page = 1,
    pageSize = 10,
}) => {
    ...
    return `${DATABASE_API_BASE}/dataset_metadata/${encodeURIComponent(dataset)}/large_meta/?${params.toString()}`
}
...
export const getTISCH2DegClusterPlotURL = ({
    dataset,
    expressionType = "exp",
}) => {
    const params = new URLSearchParams({
    ...
    return `${DATABASE_API_BASE}/${encodeURIComponent(dataset)}/tisch2_deg_cluster_plot/?${params.toString()}`
}
