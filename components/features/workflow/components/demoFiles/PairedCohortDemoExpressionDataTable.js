...
import { usePairedCohortDemoExpressionGeneList }
    from "@/components/features/workflow/hooks/usePairedCohortDemoExpressionGeneList";
import { usePairedCohortDemoExpressionData }
    from "@/components/features/workflow/hooks/usePairedCohortDemoExpressionData";
...
const PairedCohortDemoExpressionDataTable = ({
    rnaType,
}) => {
    ...
    const {
        ...
        isError: isGeneError,
    } = usePairedCohortDemoExpressionGeneList({
        rnaType,
    });
    ...
    } = usePairedCohortDemoExpressionData({
        rnaType,
        genes: selectedGenes,
    });
...
export default PairedCohortDemoExpressionDataTable;
