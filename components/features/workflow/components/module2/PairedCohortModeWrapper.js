                ...
                <Stack spacing={2}>
                    ...
                    <Space wrap>
                        ...
                        <Button
                            ...
                            disabled={isSubmitting}
                            href='/workspace/detail?taskId=9de2c6b5-034c-4c4c-811a-976fbac53215'
                            target='_blank'
                        >
                            View Demo Result
                        </Button>
                ...
                <Alert
                    ...
                    description={
                        <Box component="span" sx={{ fontSize: "14px" }}>
                            Expression matrix files and meta file should follow
                            the platform-defined format. The backend will use
                            fixed columns:
